// Seção: Instruções com Drag and Drop
...
export function InstructionsSectionV2({ form }: InstructionsSectionProps) {
  ...
  function addStep() {
    ...
    append(newStep);
    const newFields = form.getValues('instructions');
    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Defina as instruções principais do agent. Arraste para reordenar.
        </p>
      </div>
