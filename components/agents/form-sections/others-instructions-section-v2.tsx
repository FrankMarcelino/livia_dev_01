// Seção: Outras Instruções com Drag and Drop
...
export function OthersInstructionsSectionV2({ form }: OthersInstructionsSectionProps) {
  const { fields, append, remove, move } = useFieldArray({
    control: form.control,
    name: 'others_instructions',
  });
  ...
  function addStep() {
    ...
    append(newStep);
    const newFields = form.getValues('others_instructions');
    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Instruções adicionais para o agent. Arraste para reordenar.
        </p>
      </div>
